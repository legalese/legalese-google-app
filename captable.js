...
function CapTableTester(){
    //CHANGE
    //var Testsheets = SpreadsheetApp.getActiveSheet("Sheet10");
  var SpreadSheet = SpreadsheetApp.getActiveSpreadsheet();
  var captableSheet = SpreadSheet.getSheetByName("Cap Table");
  var termsheet = SpreadSheet.getSheetByName("Creation of Class F");
  var cap = new capTable_(termsheet, captableSheet);
...
*/
    var ui = SpreadsheetApp.getUi();
    var captablesheetName = ui.prompt("Enter New Sheet Name: ");

    var activeSpreadSheet = SpreadsheetApp.getActiveSpreadsheet();

    var captable = activeSpreadSheet.getSheetByName(captablesheetName) || activeSpreadSheet.insertSheet(captablesheetName);
...
function CapTableTester(){
    //CHANGE
    //var Testsheets = SpreadsheetApp.getActiveSheet("Sheet10");
    var termsheet = SpreadsheetApp.getActiveSpreadSheet();
    var captableSheet = termsheet.getSheet("Cap Table");
    var cap = new capTable_(termsheet, captableSheets);
    createCaptable(cap);
}
function createCaptable(capTable){
//  reset();
...
*/
    var ui = SpreadsheetApp.getUi();
    var newSheetResponse = ui.prompt("Enter New Sheet Name: ");

    var termsheet = capTable.termsheet || SpreadsheetApp.getActiveSpreadSheet();

    capTableSheet = termsheet.getSheet(newSheetResponse) || termsheet.insertSheet(newSheetResponse);
