...
**** The Investor Object: Data Structure

~Round.getOldInvestors()~ returns a list of Investors.

~Round.new_investors~ is an array of Investors.

~Round.ordered_investors~ is an array of Investors.
...
Whew. That was a lot of theory. But sometimes you just have a simple question and want a quick answer.
